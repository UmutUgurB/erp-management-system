...
import { Filter, X, Search, Users, Building, Calendar, TrendingUp, BarChart3 } from 'lucide-react';
...
const reportTypes = [
  ...
  { value: 'trends', label: 'Trend Analizi', icon: TrendingUp },
  { value: 'department', label: 'Departman', icon: Users },
  { value: 'individual', label: 'Bireysel', icon: Calendar }
];
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <motion.button
                  ...
                  className="inline-flex items-center px-3 py-1 text-xs font-medium rounded-full bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200 hover:bg-red-200 dark:hover:bg-red-800 transition-colors"
                >
                  Son 3 Ay
                </motion.button>
              </div>
